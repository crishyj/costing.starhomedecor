...
function addDecimal(string){
    ...
    $(document).ready(function () {
            ...
            defaultSorting: 'FirstName ASC',			
				actions: {
					listAction:   'actions/usersdg-crud.php?action=list',
					createAction: 'actions/usersdg-crud.php?action=create',
					updateAction: 'actions/usersdg-crud.php?action=update',
					deleteAction: 'actions/usersdg-crud.php?action=delete'
				},
				fields: {
                ID: {
                    key: true,
