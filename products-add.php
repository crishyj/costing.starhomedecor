...
$componentID = $row_productList['ProductCode'];
$sql = "SELECT * FROM Components WHERE ProductID = 'componentID'";
$componentList = mysqli_query($StarCreations,$sql) or die(mysqli_error($StarCreations));
$row_componentList = mysqli_fetch_assoc($componentList);
$totalRows_productList = mysqli_num_rows($productList);
            ...
            <form action="actions/product-crud.php?action=add" method="post" id="productForm"  >
                ...
                <div class="controls">
                    <div class="span12">
                        ...
                        <input type="hidden" name="ProductCode1"  id="ProductCode1" value="<?php echo $row_productList['ProductCode']; ?>" />
                        <label>Product Name</label>
			            <label>New Product ID <?php echo $newID; ?></label>
...
<script>
    ...
    $(document).ready(function(){
        ...
        var listquery;
        if(proidVar !=''){
            listquery = 'actions/component-crud.php?action=list&ProductID='+proidVar;
        }
        else{
            listquery = 'actions/component-crud.php?action=list';
        }
        //Prepare jTable
