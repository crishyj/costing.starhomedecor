...
$productList = mysql_query($query_productList, $StarCreations) or die(mysql_error());
...
$rsCustList = mysql_query($query_rsCustList, $StarCreations) or die(mysql_error());
$row_rsCustList = mysql_fetch_assoc($rsCustList);
$totalRows_rsCustList = mysql_num_rows($rsCustList);
...
$rows = mysql_num_rows($rsCustList);
if($rows > 0) {
mysql_data_seek($rsCustList, 0);
$row_rsCustList = mysql_fetch_assoc($rsCustList);
}
